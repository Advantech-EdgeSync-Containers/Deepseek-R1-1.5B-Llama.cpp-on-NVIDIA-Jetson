...
| DeepSeek R1 1.5B Inference | Efficient on-device LLM via LlamaCpp-Python; minimal memory, high performance |
...
|-----------|-----------------------------------------------------------------------------------------------------------------------------------------|
| Deepseek-R1-1.5B-Llama.cpp-on-NVIDIA-Jetson | Provides a hardware-accelerated development environment using various AI software components along with Deepseek R1 1.5B & LlamaCpp-Python |
| openweb-ui-service | Optional, provides UI which is accessible via browser for inferencing                                                                   |

### Deepseek-R1 1.5B Llama.cpp on NVIDIA Jetson Container Highlights
...
| Feature                       | Description                                                                                            |
|-------------------------------|--------------------------------------------------------------------------------------------------------|
| Local Inference Engine    | On-device model (Deepseek R1 1.5B) inference via LlamaCpp-Python (Python Wrapper for LlamaCPP) REST API. |
...
| Item  | Description                |
|-------|----------------------------|
| Model source  | Hugging Face - DeepSeek-R1-Distill-Qwen-1.5B |
...
| DeepSeek R1 1.5B | N/A     | Pulled/Stored inside LlamaCpp container and persisted |
...
git clone https://github.com/Advantech-EdgeSync-Containers/Deepseek-R1-1.5B-Llama.cpp-on-NVIDIA-Jetson.git
...
./start_services.sh
```
Allow some time for the OpenWebUI and Jetson™ DeepSeek LlamaCpp container to settle and become healthy.
...
Here are quick commands/instructions to troubleshoot issues with the Jetson™ DeepSeek LlamaCpp Container:
...
llm = Llama(model_path="./models/DeepSeek-R1:1.5B.gguf", n_ctx=2048)
